...
/** Skeleton for the map area — fills parent container to prevent CLS during idle-load swap */
export function MapSkeleton() {
  return (
    <div className="w-full h-full bg-hud-base flex items-center justify-center">
