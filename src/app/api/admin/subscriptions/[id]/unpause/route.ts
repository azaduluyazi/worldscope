...
import { unpauseSubscription, LemonApiError } from "@/lib/lemon-squeezy";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

/** POST /api/admin/subscriptions/[id]/unpause — resume a paused subscription. */
export async function POST(
  ...
  try {
    const result = await unpauseSubscription(sub.lemon_subscription_id);
