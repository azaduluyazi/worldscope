...
import { pauseSubscription, LemonApiError } from "@/lib/lemon-squeezy";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

/** POST /api/admin/subscriptions/[id]/pause — optional { resumes_at } body. */
export async function POST(
  ...
  try {
    const result = await pauseSubscription(sub.lemon_subscription_id, body.resumes_at);
